...
from hermes_maintenance_loops.scheduler import render_manifest
...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory() as temp:
        ...
        for command in [
            [sys.executable, "-m", "hermes_maintenance_loops.cli", "health", "--hermes-home", str(home)],
            [sys.executable, "-m", "hermes_maintenance_loops.cli", "improvement", "--source", str(fixture), "--runtime-dir", str(runtime)],
